package com.hsun.ywork.modules.qa.utils;
...
public class SingletonLoginUtils {
	...
	public static User getLoginSysUser(HttpServletRequest request) {
		String userKey = WebUtils.getCookie(request, CacheConstants.LOGIN_MEMCACHE_PREFIX).getValue();
		if (StringUtils.isNotEmpty(userKey)) {
			User sysUser = (User) EhCacheUtils.get(userKey);
	...
	public static User getLoginUser(HttpServletRequest request){
		String userKey = WebUtils.getCookie(request, CacheConstants.WEB_USER_LOGIN_PREFIX).getValue();
		if(StringUtils.isNotEmpty(userKey)){
			User user = (User) EhCacheUtils.get(userKey);
