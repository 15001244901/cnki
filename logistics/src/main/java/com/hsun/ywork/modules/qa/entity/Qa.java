...
public class Qa implements Serializable {
    ...
    private List<QaComment> questionsCommentList;//问答评论list
    private List<QaTagRelation> questionsTagRelationList;//问答和问答标签关联list
    private Long questionsTagId;//问答标签id
    private Date beginCreateTime;//查询 开始添加时间
    private Date endCreateTime;//查询 结束添加时间
    private String commentUserId;//用于查询我的回答
