...
public class CommentController extends BaseController {
	...
	// 评论列表
	private static String queryComment = getViewPath("/front/comment/comment");
	// 评论回复
	private static String queryCommentReply = getViewPath("/front/comment/comment_reply");
	//评论回复分页
	private static String queryCommentReplyPage= getViewPath("/front/comment/comment_reply_page");
	@Autowired
