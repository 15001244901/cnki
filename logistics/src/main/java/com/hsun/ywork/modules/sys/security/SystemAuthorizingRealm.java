...
import com.hsun.ywork.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		if (user != null) {
			...
			return new SimpleAuthenticationInfo(new Principal(user, token.isMobileLogin(),token.isLoginConsole(),token.getBackURL()),
...
//		}
	...
	public static class Principal implements Serializable {
		...
		private boolean loginConsole = true;//	是否登录控制台，默认是
...
//		private Map<String, Object> cacheMap;
		...
		public Principal(User user, boolean mobileLogin , boolean loginConsole) {
			this.id = user.getId();
			this.loginName = user.getLoginName();
			this.name = user.getName();
			this.mobileLogin = mobileLogin;
		...
		public Principal(User user, boolean mobileLogin , boolean loginConsole , String backURL) {
			this.id = user.getId();
			this.loginName = user.getLoginName();
			this.name = user.getName();
			this.mobileLogin = mobileLogin;
