...
import com.hsun.ywork.common.utils.MD5Utils;
...
public class AdminKpointController extends BaseController {
	...
	// 章节列表 
	private static final String kpointList = getViewPath("/course/kpoint_list");// 章节列表
    ...
    public Object ccVideoTHQSData(HttpServletRequest request){
    	...
    	try{
			...
			String hash= MD5Utils.getMD5(infoStrSalt);
			infoStr+="&hash="+hash;
