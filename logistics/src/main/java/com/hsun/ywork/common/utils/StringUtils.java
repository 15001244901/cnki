...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String formatByPattern2TargetString(String origStr , String targetStr , String patternStr){
    	//"\\[BlankArea.+?]"
		Pattern e3 = Pattern.compile(patternStr);
		Matcher config = null;
		config = e3.matcher(origStr);
		return config.replaceAll(targetStr);
	}
