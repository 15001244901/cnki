...
<title>课程节点</title>
	...
	<link type="text/css" href="${ctxStatic}/other/admin/css/layout.css" rel="stylesheet" />
	<script type="text/javascript" src="${ctxStatic}/other/common/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="${ctxStatic}/other/common/admin/js/admin-inxedu.js"></script>
	<%--<script type="text/javascript" src="${ctxStatic}/other/common/webutils.js"></script>--%>
	<script type="text/javascript" src="${ctxStatic}/hsun/front/qa/js/webutils.js${v}"></script>
	<link type="text/css" rel="stylesheet" href="${ctxStatic}/other/common/ztree/css/zTreeStyle.css" />
<script type="text/javascript" src="${ctxStatic}/other/common/ztree/jquery.ztree.core-3.5.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/other/common/ztree/jquery.ztree.excheck-3.5.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/other/common/ztree/jquery.ztree.exedit-3.5.min.js"></script>
	<%--<link rel="stylesheet" type="text/css" href="${ctxStatic}/other/common/kindeditor/themes/default/default.css" />--%>
	<%--<script type="text/javascript" src="${ctxStatic}/other/common/kindeditor/kindeditor-all.js"></script>--%>
<script type="text/javascript" src="${ctxStatic}/hsun/front/qa/js/kpoint.js${v}"></script>

<script type="text/javascript" src="${ctxStatic}/other/common/uploadify/ccswfobject.js"></script>

<script type="text/javascript" src="${ctxStatic}/other/common/uploadify/swfobject.js"></script>
<script type="text/javascript" src="${ctxStatic}/other/common/uploadify/jquery.uploadify.v2.1.4.min.js"></script>
...
//			initKindEditor_addblog('content', 580, 350,'courseContxt','true');
		...
		function uploadPicLoad(fileupload,showId,fileQueue){
			...
			$("#"+fileupload).uploadify({
				'uploader' : ctxStatic+'/other/common/uploadify/uploadify.swf', //上传控件的主体文件，flash控件  默认值='uploadify.swf'
				'script'  :ctxRoot+'/course/uploadvideo',
				...
				'buttonImg' : ctxStatic+'/other/common/uploadify/liulan.png',//使用图片按钮，设定图片的路径即可
				'width' : 105,
				...
				'cancelImg' : ctxStatic+'/other/common/uploadify/cancel.png',
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
		...
		<tr>
			<th colspan="2" align="left">
				<span style="padding-left: 30px;">${courseSellType}课程管理</span>
		...
		<tr>
			<td width="20%">
				<fieldset style="height: 662px;">
					<legend>
						<a href="${ctx}/course/list">${courseSellType}课程列表</a>
						&gt;
						<span>课程管理</span>
					</legend>
					<div class="mt20">
							...
							<form id="updateForm">
								...
								<table style="line-height: 35px;" width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
									...
									<tr style="display:none" class="tr_all videoType ">
										...
										<td style="text-align: left;">
											<select id="courseKpointVideoType" name="courseKpoint.videoType" >
												<option value="HXFYVIDEO">地理视频云</option>
									...
									<tr class="tr_all txtContent" style="display: none;">
										<td>文本内容:</td>
										<td>
											<script id="content_script" type="text/plain">${courseKpoint.content}</script>
											<textarea id="content" name="courseKpoint.content" rows="" cols="">${courseKpoint.content}</textarea>
											<sys:ckeditor replace="content" uploadPath="/course" height="100"/></td>
									</tr>
									...
									<tr class="tr_all videoType" id="teacherTr">
										<td>视频讲师:</td>
										<td style="text-align: left;">
                                            <select id="teacher" name="courseKpoint.teacherId" style="width:120px">
                                                <option value="">请选择</option>
                                                <c:forEach var="item" items="${allTeachers}">
