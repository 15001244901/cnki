...
<body>
	...
	<!-- 删除面板 -->
	<section class="del_item">
		<div class="del_item_panel">
			<div data-del=true class="bgclick">删除</div>
			<div data-del=false class="bgclick">取消</div>
		</div>
	</section>
	...
	<script id="list_model" type="text/template">
		<li class="flex" id="item_{{id}}">
			<div class="flex exam_infor" data-id="{{id}}">
				<!-- <div class="exam_logo">
					<i class="icon iconfont icon-lianxi"></i>
				</div> -->
				<div>
					<div class="exam_title">{{name}}</div>
					<div class="exam_data">练习日期：{{testdate}}</div>
				</div>
			</div>
			<div class="del_btn bg_danger flex flex-center" onclick="showDel(this,'{{id}}')">
				删除
			</div>
		</li>
	</script>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/userCenter/practiceRecord.js${v}"></script>
</body>
</html>