...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctxStatic}/hsun/front/css/library/reading_page_one.css${v}" />
	...
	<body>
		...
		<div id="divcontent">
			<div class="nav">
				...
				<span class="golibrary" onclick="library.goBack();"><i class="fa fa-share "></i></span>
				<span class="updown" style="display: none;position: relative;top:1px;" onclick="library.upDown();" title="下载文件"><i class="fa  fa-download "></i></span>
			...
			<input type="hidden" id="updown" />
		</div>
	</body>

</html>
<script type="text/javascript" src="${ctxStatic}/hsun/front/js/pagejs/library/knowlwdge_detail.js${v}"></script>