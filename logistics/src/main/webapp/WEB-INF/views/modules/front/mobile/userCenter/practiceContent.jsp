...
<body>
	<div class="body_container">
		<header class="bg1 color1 top_header">
			<i class="icon iconfont icon-jt-left" onclick="window.location.href='practiceRecord.html';"></i>
			<span class="exam_time flex flex-center">练习记录</span>
		</header>
	...
	<section class="question_table flex_table">
		...
		<section class="question_table_infor">
			<div class="question_table_infor_cont">
				<div class="table_infor_list flex"><em>练习名称：</em><span class="exam_name"></span></div>
				<div class="table_infor_list"><em>练习耗时：</em><span class="exam_costtime"></span></div>
			</div>
		</section>
	...
	<script id="qtype1" type="text/template">
		<div class="daily_ques" id="pos_{{id}}">
			...
			<span class="ques_num" style="float: left;">{{num}}</span>{{qcontent}}
			</div>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/userCenter/practiceContent.js${v}"></script>
</body>
</html>