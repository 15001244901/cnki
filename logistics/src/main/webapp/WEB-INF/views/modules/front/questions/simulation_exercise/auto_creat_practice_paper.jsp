...
<div id="auto_model" class="auto_model">
    <div class="navigation_bar">
        <span onclick="skip('0')">&nbsp;&nbsp;按知识点练习&nbsp;&nbsp;</span>
        <span onclick="skip('1')" class="spansubjecttitle">&nbsp;&nbsp;智能组卷练习&nbsp;&nbsp;</span>
        <span onclick="skip('2')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;套题练习&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    </div>
    <div id="bo_fl">
        <div class="sel">
            <div class="sel_title">
            ...
            <ul id="sel_types"  class="sel_types dash_line">
                <!-- <li id="k0"><a class="get_types" href="javascript:void(0);" data-type="0">煤炭采样1</a></li>
                <li id="k1"><a class="get_types" href="javascript:void(0);" data-type="1">煤炭采样2</a></li>
                <li id="k2"><a class="get_types" href="javascript:void(0);" data-type="2">煤炭采样3</a></li>
                <li id="k3"><a class="get_types" href="javascript:void(0);" data-type="3">煤炭采样4</a></li>
                <li id="k4"><a class="get_types" href="javascript:void(0);" data-type="4">煤炭采样5</a></li> -->
            </ul>
            ...
            <ul class="one_section dash_line">
                <%--<li>--%>
                    <%--<div class="one_title">--%>
                        <%--<span class="title_up cuesor title_radio1"></span>--%>
                        <%--<b class="title_checkbox1 cuesor" data-type="1"></b>--%>
                        <%--<em class="title_up cuesor">人教版</em>--%>
                    <%--</div>--%>
                    <%--<ul class="two_section dash_line">--%>
                        <%--<li>--%>
                            <%--<div class="one_title">--%>
                                <%--<span class="title_up cuesor title_radio1"></span>--%>
                                <%--<b class="title_checkbox1 cuesor" data-type="1-1"></b>--%>
                                <%--<em class="title_up cuesor">第二集人教版</em>--%>
                            <%--</div>--%>
                            <%--<ul class="three_section dash_line">--%>
                                <%--<li>--%>
                                    <%--<div class="one_title">--%>
                                        <%--<span class=""></span>--%>
                                        <%--<b class="title_checkbox1 cuesor" data-type="1-1-1"></b>--%>
                                        <%--<em class="cuesor">第三集人教版</em>--%>
                                    <%--</div>--%>
                                <%--</li>--%>
                                <%--<li>--%>
                                    <%--<div class="one_title">--%>
                                        <%--<span class=""></span>--%>
                                        <%--<b class="title_checkbox1 cuesor" data-type="1-1-2"></b>--%>
                                        <%--<em class="cuesor">第三集人教版</em>--%>
                                    <%--</div>--%>
                                <%--</li>--%>
                            <%--</ul>--%>
                        ...
                        <%--<li>--%>
                            <%--<div class="one_title">--%>
                                <%--<span class="title_up cuesor title_radio1"></span>--%>
                                <%--<b class="title_checkbox1 cuesor" data-type="1-2"></b>--%>
                                <%--<em class="title_up cuesor">第二集人教版</em>--%>
                            <%--</div>--%>
                        <%--</li>--%>
                    <%--</ul>--%>
    ...
    <div id="bo_fr">
        <form id="select-form">
            <div id="coner">
                ...
                <div class="set_paper_name">
                    试卷名称：<input type="text" name="p_name"><br>
                    <br>
                    答题时间：<input type="text" name="p_duration">
                </div>
            ...
            <input id="txtTotalScore" name="p_totalscore" type="hidden"/></span>
            <input id="txtPassScore" name="p_passscore" type="hidden"/></span>
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/js/pagejs/questions/simulation_exercise/auto_creat_practice_paper.js${v}"></script>
</body>
</html>