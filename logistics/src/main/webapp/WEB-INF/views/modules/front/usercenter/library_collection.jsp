...
<html>
	...
	<body>
		...
		<div class="divcontent">
			<div id="section">
				<span class="active"><a class="library_center" href="library_collection.html">知识文库</a></span>
				<%--<span class="title"><a class="library_center" href="inner_library.html">内部文库</a></span>--%>
			</div>
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/usercenter/js/library_collection.js${v}"></script>
