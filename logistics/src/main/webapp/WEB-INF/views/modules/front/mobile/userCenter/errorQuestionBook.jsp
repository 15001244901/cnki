...
<body>
	<div class="body_container">
		...
		<section class="page">
			...
			<div class="page_num">
				...
				<div>
					<span>跳转到:</span><input type="text" name="pagenum" value="">页<button class="page_num_btn bgclick">跳转</button>
				</div>
			</div>
		</section>
	...
	<script type="text/template" id="ques_type_1">
		<li>
			...
			<div class="question_btn">
				...
				<span onclick="collectQue(this,'{{delid}}'	);"><i class="icon iconfont icon-shanchu"></i>删除</span>
	...
	<script type="text/template" id="ques_type_3">
		<li>
			...
			<div class="question_btn">
				<span onclick="seeAnswer(this);"><i class="icon iconfont icon-chakan"></i>查看答案</span>
				<span onclick="collectQue(this,'{{id}}'	);"><i class="icon iconfont icon-shanchu"></i>删除</span>
				<span onclick="findError(this,'{{delid}}');"><i class="icon iconfont icon-jiucuo"></i>纠错</span>
				<span onclick="takeNode(this,'{{id}}');"><i class="icon iconfont icon-biji"></i>笔记</span>
			</div>
		</li>
	</script>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/userCenter/errorQuestionBook.js${v}"></script>
</body>
</html>