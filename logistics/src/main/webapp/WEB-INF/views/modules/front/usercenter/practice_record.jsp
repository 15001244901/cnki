				...
				<div class="user-con" style="padding:0;">
					<div class="userzj-list">
						<ul class="f-cb" id="tableContent">
						    <!-- <li>
								<a href="javascript:;" class="icon-trash J_TrashIt" title="取消收藏">删除</a>
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/usercenter/js/practice_record.js${v}"></script>