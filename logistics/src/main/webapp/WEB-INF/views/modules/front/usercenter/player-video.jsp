...
<script src="http://www.bfvyun.com/html/script/bfcloud.js?v=1"></script>
	<style id="new_hide">
		.p-h-r-title,#p-h-r-cont{
			display: none;
		}
	</style>
</head>
<body>
																...
																>
																	<c:forEach items="${parentKpoint.kpointList}" var="sonKpoint">
																		<li class="lh-menu-second ml30">
																			<a id="kpoint-${sonKpoint.kpointId }" href="javascript:void(0)" onclick="getPlayerHtml(${sonKpoint.kpointId },'${sonKpoint.name }',this)" class="" title="">
																				<span class="fr">
	...
	<script src="${ctxStatic}/hsun/front/qa/js/comment.js" type="text/javascript"></script><!-- 评论js -->
	<script type="text/javascript" src="${ctxStatic}/other/common/kindeditor/kindeditor-all.js"></script>
	<script type="text/javascript" src="${ctxStatic}/hsun/front/qa/js/playVideo.js"></script>
	...
	$(function(){
		var currentKpoint = '${currentKpoint.kpointId}';
		if(currentKpoint) {
			$('#kpoint-${currentKpoint.kpointId}').trigger('click');
			$('#kpoint-${currentKpoint.kpointId}').closest('.lh-menu-stair').children('a').trigger('click');
		}
	});
	</script>
</body>
