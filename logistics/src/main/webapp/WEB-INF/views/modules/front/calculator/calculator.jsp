...
<head>
	...
	<link href="${ctxStatic}/hsun/front/calculator/css/CalcSS3.css" rel="stylesheet" type="text/css" />
	<link href="${ctxStatic}/hsun/front/calculator/css/index.css" rel="stylesheet" type="text/css" />
	<!--[if IE]>
...
<body>
	...
	<script type="text/javascript" src="${ctxStatic}/hsun/front/calculator/js/CalcSS3.js"></script>
</body>
</html>