		...
		<div class="" style="padding:10px;">
			<section>
				<div class="mobile_hide">
					<span class="fr"><a href="${ctxRoot}/qa/questions/toadd" title="" target="_blank" class="comm-btn c-btn-6" style="font-size: 16px; height: 22px; line-height: 22px; padding: 0 20px;">去提问</a></span>
					<section class="c-infor-tabTitle c-tab-title cnew-tab-title">
						<%--<a href="javascript: void(0)" title="我的问答" style="cursor: default;">我的问答</a>--%>
						<a href="${ctxRoot}/qa/myqa/list" title="我的提问">我的提问</a>
						<a href="${ctxRoot}/qa/myrepqa/list" title="我的回答" class="current">我的回答</a>
					</section>
				</div>
				<div class="mt40 mobile_top0">
									...
									<c:forEach items="${questionsList }" var="question">
										<li>
											...
											<section class="q-txt-box">
												<a class="replyBrowseNum" href="${ctxRoot}/qa/questions/info/${question.id }" target="_blank" title="">
													<div class="replyNum">
												...
												<h3 class="hLh30 txtOf">
													...
													<a href="${ctxRoot}/qa/questions/info/${question.id }" title="" target="_blank" class="fsize16 c-333 vam">${question.title }</a>
												</h3>
													...
													<section class="fl ml20 pt10">
														<div class="taglist clearfix">
															<c:forEach items="${question.questionsTagRelationList }" var="questionsTag">
																<a title="${questionsTag.tagName }" target="_blank" data-id="${questionsTag.questionsTagId }" class="list-tag" href="${ctxRoot}/qa/questions/list?questions.questionsTagId=${questionsTag.questionsTagId }">${questionsTag.tagName }</a>
															</c:forEach>
														</div>
													</section>
													<div class="clear"></div>
					...
					<!-- 公共分页 结束 -->
					<form action="${ctx}/qa/myrepqa/list" id="searchForm" method="post">
