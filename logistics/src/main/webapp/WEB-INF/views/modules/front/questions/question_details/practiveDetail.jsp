			...
			<div class="left">
				<div class="ess_infor">
					...
					<ul>
						...
						<%--<b>考试时长 :</b><span class="p_width1" id="spanDuration"> </span>--%>
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/js/pagejs/questions/question_details/practiveDetail.js${v}"></script>