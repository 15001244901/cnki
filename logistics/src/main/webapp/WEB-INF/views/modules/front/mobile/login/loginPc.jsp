...
<head>
	...
	<%--<link rel="stylesheet" href="${ctxStatic}/hsun/front/mobile/css/header.css">--%>
	<link rel="stylesheet" href="${ctxStatic}/hsun/front/mobile/css/login/loginPc.css${v}">
	<%--<script src="${ctxStatic}/hsun/front/mobile/js/flexible.js"></script>--%>
...
<body>
	<article class="login">
		<header class="bg1 color1">
			<i class="icon iconfont icon-jt-left remove_login"></i>
			<span>登录</span>
		</header>
