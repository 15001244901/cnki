...
<body>
	<div class="body_container">
		...
		<footer class="bg1">
			...
			<a class="text_login_btn" data-href="${ctxRoot}/page/mobile/video/" data-bg="video"><i class="icon iconfont icon-spzx"></i><br>视频</a>
			<a class="text_login_btn" data-href="${ctxRoot}/page/mobile/userCenter/" data-bg="userCenter"><i class="icon iconfont icon-grzx"></i><br>我的</a>
		</footer>
	</div>
	...
	<script id="list_model" type="text/template">
		<li class="flex" id="item_{{id}}" >
			<div class="flex exam_infor" data-id="{{id}}" data-bj="{{bj}}">
				<!-- <div class="exam_logo">
					<i class="icon iconfont icon-lianxi"></i>
				</div> -->
				<div>
					<div class="exam_title">{{name}}</div>
					<div class="exam_data">考试日期：{{starttime}}</div>
					<div class="exam_data">结束日期：{{endtime}}</div>
				</div>
			</div>
		</li>
	</script>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/exam/overExamList.js${v}"></script>
