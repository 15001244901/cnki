...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctxStatic}/hsun/front/css/questions/test_sets/paper/paper_edit_random.css${v}" />
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/js/pagejs/questions/test_sets/paper/paper_edit_random.js${v}"></script>