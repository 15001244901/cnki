...
<body>
	<div class="body_container">
		...
		<section class="daily_pra_title flex pl_r15">
			...
			<span><b id="pagesize">1</b> / <i id="totalsize">1</i></span>
		</section>
		...
		<section class="page">
			<div class="page_html">
				...
				<div class="page_list page_btnr"><div onclick="saveQuesFun();" class="page_save bg_danger"><i>提交</i></div></div>
			</div>
		</section>
	</div>
	<!-- 答题卡 -->
	<section class="question_table flex_table">
		...
		<footer>
			<div class="flex flex-center bg_warn reset_btn ques_table_hide">继续练习</div>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/practice/dailyPractice.js${v}"></script>
</body>
</html>