			...
			<li class="unBr">
				<aside class="noter-pic">
					<c:if test="${empty user.photo }">
						<img width="50" height="50" class="picImg" src="${ctxStatic}/hsun/front/qa/img/avatar-boy.gif">
					</c:if>
					<c:if test="${!empty user.photo }">
						<img width="50" height="50" class="picImg" src="${user.photo }">
					</c:if>
				</aside>
				<div class="of">
					...
					<c:forEach items="${commentList }" var="ac">
						<li>
							<aside class="noter-pic">
								...
								<c:if test="${!empty ac.picImg }">
									<img width="50" height="50" class="picImg" src="${ac.picImg }">
								</c:if>
							</aside>
							<div class="of">
								<span class="fl"> 
