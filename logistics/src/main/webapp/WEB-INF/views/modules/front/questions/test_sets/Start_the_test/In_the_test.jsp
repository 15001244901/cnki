		...
		<div id="div">
			<div>
				...
				<div class="twos">
					...
					<span>总分值：<input type="text" id="txtTotalScore" disabled="disabled" class="style" value="" /></span>
					<span>题目数量：<input type="text" id="txtCount" disabled="disabled" class="style" value="" /></span>
					<span>时间（分钟）：<input type="text" id="txtDuration" disabled="disabled" class="style" value="" /></span>
				</div>
			</div>
			<div>
				<form>
					<div class="left">
						...
						<div class="div3" onclick="inTheTest.spanPause()">
						...
						<div class="div5" onclick="inTheTest.savaQuestions()">
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/js/pagejs/questions/test_sets/Start_the_test/In_the_test.js${v}"></script>
