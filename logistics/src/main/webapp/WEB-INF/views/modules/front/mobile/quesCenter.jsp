...
<body>
	...
	<script type="text/template" id="ques_type_1">
		<li>
			...
			<div class="question_btn">
				...
				<span onclick="collectQue(this,'{{id}}','{{iscollected}}');"><i class="icon iconfont {{love}}"></i>{{lovetext}}</span>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/questionCenter.js${v}"></script>
</body>
</html>