...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctxStatic}/hsun/front/css/questions/test_sets/create_test_paper/create_test_paper_two.css${v}" />
		...
		<div id="divcontent">
			...
			<div class="divvalue">
				<ul>
					<li>
						<span>试卷名称：</span>
						<input type="text" class="txtinput" id="txtName" />
					</li>
					<li>
						<span>题目数量：</span>
				...
				<div class="footer">
					<span><a href="javascript:;" onclick="createTestPaperTwo.spanReset()">&nbsp;&nbsp;&nbsp;&nbsp;重置&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
					<span><a href="javascript:;"  class="active" onclick="createTestPaperTwo.submitPaper()">创建试卷</a></span>
				</div>
			</div>
		</div>
	</body>
...
<script type="text/javascript" src="${ctxStatic}/hsun/front/js/pagejs/questions/test_sets/create_test_paper/create_test_paper_two.js${v}"></script>