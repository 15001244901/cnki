...
<head>
	...
	<link rel="stylesheet" href="${ctxStatic}/hsun/front/mobile/css/userCenter/errorCorrection.css${v}">
...
<body>
	...
	<!-- 列表模板 -->
	<script id="error_model" type="text/template">
		<li>
			<div>
				<h3 class="flex flex-rols-between">纠错内容 <span>提交时间:{{createDate}}</span></h3>
				<p>{{content}}</p>
			</div>
			<div class="error_msg flex flex-rols-between">
				<span>审核状态：<em>{{errstate}}</em></span><a href="{{href}}">查看试题</a>
			</div>
		</li>
	</script>
	...
	<script src="${ctxStatic}/hsun/front/mobile/js/userCenter/errorCorrection.js${v}"></script>
</body>
</html>