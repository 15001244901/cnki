...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/logistics/gooddatesum/">货物信息列表test2</a></li>
		<li class="active"><a href="${ctx}/logistics/gooddatesum/form?id=${gooddatesum.id}">货物信息<shiro:hasPermission name="logistics:gooddatesum:edit">${not empty gooddatesum.id?'修改test2':'添加test2'}</shiro:hasPermission><shiro:lacksPermission name="logistics:gooddatesum:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="gooddatesum" action="${ctx}/logistics/gooddatesum/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="gfhrq" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${gooddatesum.gfhrq}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="logistics:gooddatesum:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
