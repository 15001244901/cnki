        ...
        <form class="login-form" id="loginForm" action="${ctx}/login" method="post">
            <div class="row">
                <div class="input-field col s12 center">
                    ...
                    <p class="center login-form-text">欢迎使用地理云课堂</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12 m12 l12  login-text">
                    <input type="checkbox" id="loginConsole" name="loginConsole"/>
                    <label for="loginConsole" title="勾选则登录到控制台">登录控制台</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
            ...
            <div class="row">
                <div class="input-field col s6 m6 l6">
                    <p class="margin medium-small"><a href="page-register.html">马上注册!</a></p>
                </div>
                <div class="input-field col s6 m6 l6">
