...
<body>
	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="parent" name="parentId" value="${parentDict.id}" labelName="parent.name" labelValue="${parentDict.label}"
								title="父级编号" url="/sys/dict/treeData" extId="${parentDict.id}" cssClass="" allowClear="true"/>
			</div>
		</div>
		<div class="control-group">
