...
<script type="text/javascript" src="${ctxStatic}/modules/course/js/page.js"></script>
<c:if test="${page != null && page.totalResultSize>0}">
	...
	<div class="pagination">
		...
		<li class="c_333">
			...
			<tt><input type="button" onclick="goPageByInput()" value="确定" class="button"></tt>
			&nbsp;&nbsp;
		</li>
		</ul>
...
<script type="text/javascript">	
	...
	showPageNumber(${page.currentPage});
</script>