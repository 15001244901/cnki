$(function(){
    ...
    var quesCenter = function(){
            ...
            $.ajax({
                ...
                success: function(t) {
                    ...
                    for(var i in data){
                        ...
                        // 判断是否收藏
                        if(datalist[i].iscollected){
                            dictionary.iscollected = datalist[i].iscollected;
                            dictionary.love = 'icon-unlove';
                            dictionary.lovetext = '取消收藏';
                        }else{
                            dictionary.iscollected = '';
                            dictionary.love = 'icon-love';
                            dictionary.lovetext = '收藏';
                        }
                        // 判断是否有解析
        ...
        //收藏试题
        collectQue = function(is,id,loveid){
