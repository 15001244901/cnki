        ...
        $.ajax({
            ...
            success: function (t) {
                ...
                if (true) {
                    ...
                    // $('#userscore').find('span').html(detail.userscore);
                    // $('#startdate').find('span').html(detail.timecost);
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        for (var j = 0; j < questions.length; j++) {
                            var eid = "Q-" + questions[j].id;
                            //考生答案
                            var answered = data[eid];
                            ...
                            if (questions[j].qtype == 1) { //单选
                                ...
                                html.push('<div>');
                                html.push(' <div class="two1"> <span class="span_title" >' + num + '、(<i class="fen">'+ questions[j].qscore +'</i>)&nbsp;</span>' + questions[j].qcontent + '</div>');
...
//								}
                                ...
                                html.push('<div>');
                                html.push(' <div class="two1">' + num + '、(<i class="fen">'+ questions[j].qscore +'</i>)&nbsp;' + questions[j].qcontent + '</div>');
                                html.push(' <div class="answer" >');
...
//								}
                                ...
                                html.push('<div>');
                                html.push(' <div class="two1"> ' + num + '、(<i class="fen">'+ questions[j].qscore +'</i>)&nbsp;' + qcontent + '</div>');
                                html.push(' <div class="answer" >');
...
//								}
                    ...
                    for (var l = 0; l < datas.length; l++) {
                        ...
                        cardHtml.push('   <span class="fr">' + (stu_scoerd||'0') + '分</span>');
