				...
				if(success) {
					if(typeof(datas) == "undefined") {
						...
						for(var i = 0; i < datas.length; i++) {
							...
							contenthtml.push('    <span class="three1"><a href="'+urlpath+'/page/standard/tour.html?id=' + datas[i].id + '">标准编号：' + datas[i].sno + '</a></span>');
							...
							// 							contenthtml.push('      <i class="fa   fa-user"></i> <span style="font-size: 12px;">24</span> &nbsp;&nbsp;&nbsp;&nbsp;');
							// 							contenthtml.push('      <i class="fa  fa-folder-open-o"></i>');
							// 							contenthtml.push('    </span>');
							// contenthtml.push('  </div>');
							contenthtml.push('</div>');
						}
			...
			success: function(t) {
				...
				if(success) {
					if(typeof(datas) == "undefined") {
						...
						var contenthtml = [];
						contenthtml.push('<tr>');
						contenthtml.push('  <td class="td1">标准号</td>');
						contenthtml.push('  <td class="td2">标准名称</td>');
						contenthtml.push('  <td class="td3">标准年号</td>');
						contenthtml.push('  <td class="td4">状态</td>');
						contenthtml.push('  <td class="td5">中标分类</td>');
						contenthtml.push('</tr>');
						for(var i = 0; i < datas.length; i++) {
							contenthtml.push('<tr>');
							contenthtml.push('  <td class="td1"><a href="'+urlpath+'/page/standard/tour.html?id=' + datas[i].id + '" style="color:#2f96e9">' + datas[i].sno + '</a></td>');
