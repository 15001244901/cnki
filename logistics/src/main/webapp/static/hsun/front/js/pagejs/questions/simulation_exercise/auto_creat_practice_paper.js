$(function () {
    var autoModel = function () {
        ...
        this.flHeight = function () {
            // that.seltypes.height(that.coner.height() - 60);
        };
        ...
        this.formBtns = function (e) {
            ...
            if(!$('input[name = p_duration]').val() ||!$('input[name = p_name]').val() ){
                layer.open({
                    title: '系统提示',
                    closeBtn: 1,
                    skin: 'layui-layer-molv',
                    content: '<div style="text-align:center;font-sizze:13px;">试卷名称或答题时间不能为空</div>',
                    yes: function (index, layero) {
                        layer.close(index);
                    }
                });
            ...
            formSerialize = formSerialize + "&ptype=2&p_dbids";
                ...
                success: function (t) {
                    ...
                    if (success) {
                        ...
                        layer.open({
                            ...
                            closeBtn: 0,
                            skin: 'layui-layer-molv',
                            content: '<div style="text-align:center;">组卷成功</div>',
                            yes: function (index, layero) {
                                layer.close(index);
                        ...
                        layer.open({
                            ...
                            closeBtn: 0,
                            skin: 'layui-layer-molv',
                            content: '<div style="text-align:center;">组卷失败</div>',
                            yes: function (index, layero) {
                                layer.close(index);
                            }
                        });
        ...
        this.init = function () {
            ...
            $('input[name=p_duration]').inputmask('9{1,6}',{placeholder:"", clearMaskOnLostFocus: false });
