					...
					for(j = 0; j < datas.length; j++) {
						if(datas[j].pId == 0) {
							...
							if(rtype == "1"){
								...
								contenthtml.push('  <a href="'+urlpath+'/page/library/knowledge_detail.html?id=' + datas[j].docId + '" target="_blank"><span class="icona-jiexi" title="查看"></span></a>');
							...
							for(x = 0; x < datas.length; x++) {
								if(datas[x].pId == datas[j].id) {
									contenthtml.push('<li>');
									contenthtml.push('  <a style="" href="../library/knowledge_detail.html?id=' + datas[x].docId + '">' + datas[x].name + '</a>');
									...
									contenthtml.push('  <a href="../library/knowledge_detail.html?id=' + datas[x].docId + '" target="_blank"><span class="icona-jiexi" title="查看"></span></a>');
									contenthtml.push('</li>');
									contenthtml.push('<hr />');
								}
							}
