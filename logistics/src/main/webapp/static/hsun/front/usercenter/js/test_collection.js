					...
					for(var i = 0; i < datas.length; i++) {
						...
						if(datas[i].qtype == "1" || datas[i].qtype == "2") {
							...
							for(var j = 0; j < qdatajsons.length; j++) {
								...
								var alisaContent = collectionRecord.delP(qdatajsons[j].text);
								contenthtml.push('<div>');
						...
						contenthtml.push('      </a>');
						contenthtml.push('      <a href="javascript:;" onclick="collectionRecord.collection(\'' + datas[i].id + '\',\'' + (datas[i].userQuestion.id||'') + '\',this)">');
						...
						// contenthtml.push('      </a>');
						// contenthtml.push('      <a target="_blank" href="../questions/question_details/Collection_content.html?id=' + datas[i].id + '">');
